...
parser.add_argument('--data', default='data/real/', type=str, help='path to the data')
parser.add_argument('--split', default='data/split/real1/', type=str, help='path to the split folder')
